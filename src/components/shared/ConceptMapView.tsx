...
const ACCENT: Record<Accent, { text: string; bg: string; border: string; badge: string; dot: string }> = {
  ...
  emerald: { text: 'text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/25', badge: 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30', dot: 'bg-emerald-500' },
  amber: { text: 'text-amber-400', bg: 'bg-amber-500/10', border: 'border-amber-500/25', badge: 'bg-amber-500/20 text-amber-400 border-amber-500/30', dot: 'bg-amber-500' },
}
